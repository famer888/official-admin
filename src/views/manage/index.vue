    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
      ...
      >
        <div class="flex-shrink-0 w-auto h-24 md:h-full relative">
          <img :src="helpCenterIcon" alt="帮助中心" class="w-auto h-full object-contain mx-auto md:mx-0" />
        </div>
      ...
      >
        <VideoPlayer :video-url="videoUrl" :cover="videoCover" />
      </div>
    </div>
  </div>
</template>
...
import topBannerBg from '@/assets/images/mag-top-bg.jpg'
import helpCenterIcon from '@/assets/images/help-center.png'
